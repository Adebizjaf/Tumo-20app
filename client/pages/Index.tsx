    ...
    <div className="w-full max-w-full space-y-8 lg:space-y-10">
      ...
      {(commonPhrases[state.sourceLanguage] || commonPhrases[state.targetLanguage]) && (
        <section className="w-full">
          <div className="relative overflow-hidden rounded-3xl border border-border/40 bg-gradient-to-br from-primary/5 via-background to-primary/5 p-6 sm:p-8 shadow-lg backdrop-blur-sm">
            ...
            <div className="relative space-y-6">
              {/* Header */}
              <div className="flex items-center justify-center gap-3 pb-4 border-b border-border/30">
                ...
                <h3 className="text-xl sm:text-2xl font-bold tracking-wide bg-gradient-to-r from-primary via-primary/80 to-primary bg-clip-text text-transparent">
                  QUICK PHRASES
                </h3>
              </div>
                    ...
                    <div className="space-y-2">
                      {(commonPhrases[state.sourceLanguage] || []).slice(0, 7).map((phrase, index) => (
                        <Button
                          ...
                          className="w-full justify-start rounded-xl border-border/40 bg-background/80 px-5 py-6 text-left text-base font-medium transition-all duration-200 hover:scale-[1.02] hover:border-primary/50 hover:bg-primary/10 hover:shadow-md hover:shadow-primary/20"
                        >
